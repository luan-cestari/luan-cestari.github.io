...
- Luan's Blog (this repository) is based on https://github.com/Huxpro/huxpro.github.io
...
```
# Site settings
title: luan-cestari's Blog        # title of your website
SEOTitle: luan-cestari's Blog     # check out docs for more detail
description: "Cool Blog"          # ...

# SNS settings      
github_username: luan-cestari     # modify this account to yours
weibo_username: luan-cestari      # the footer woule be auto-updated.
...
We default support *[Featured Tags](#featured-tags)*, *[Mini About Me](#mini-about-me)*  these three modules and you can add your own. The sidebar is naturally responsive and would be push to bottom in a small screen size (`<= 992px`, according to [Bootstarp Grid System](http://getbootstrap.com/css/#grid))  
...
This theme support both [Disqus](http://disqus.com)
...
Support Google Analytics with a simple config:

```
# Google Analytics
ga_track_id: 'UA-4xxxxx'
ga_domain: aaaa
```
...
Luan's Blog is derived from [Hux Blog (Apache License 2.0)](https://github.com/Huxpro/huxpro.github.io)
